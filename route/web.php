...
Route::add('POST', '/phones/store', [Controller\PhoneController::class, 'store'])
    ->middleware('auth', 'adminOrSysadmin');
...
Route::add('GET', '/phones/by-room', [Controller\PhoneController::class, 'byRoom'])
    ->middleware('auth');
Route::add('GET', '/phones/by-user', [Controller\PhoneController::class, 'byUser'])
    ->middleware('auth');
Route::add('GET', '/phones/count-by-department', [Controller\PhoneController::class, 'countByDepartment'])
    ->middleware('auth');
Route::add('GET', '/phones/count-by-room', [Controller\PhoneController::class, 'countByRoom'])
    ->middleware('auth');
...
Route::add(['GET', 'POST'], '/rooms/create', [Controller\RoomController::class, 'create'])
    ->middleware('auth', 'adminOrSysadmin');
Route::add(['POST'], '/rooms/update', [Controller\RoomController::class, 'update'])
    ->middleware('auth', 'adminOrSysadmin');
Route::add('POST', '/rooms/store', [Controller\RoomController::class, 'store'])
    ->middleware('auth', 'adminOrSysadmin');
...
Route::add(['GET', 'POST'], '/departments/create', [Controller\DepartmentController::class, 'create'])
    ->middleware('auth', 'adminOrSysadmin');
Route::add(['POST'], '/departments/update', [Controller\DepartmentController::class, 'update'])
    ->middleware('auth', 'adminOrSysadmin');
Route::add('POST', '/departments/store', [Controller\DepartmentController::class, 'store'])
    ->middleware('auth', 'adminOrSysadmin');
